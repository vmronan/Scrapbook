...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Create scrapbook view controller
    self.scrapbookVC = [[ScrapbookVC alloc] initWithStyle:UITableViewStylePlain];
    self.scrapbookVC.model = [[ScrapbookModel alloc] init];
